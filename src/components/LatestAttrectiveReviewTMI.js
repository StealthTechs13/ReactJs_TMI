...
import '../App.css';
import '../App.scss';
function LatestAttrectiveReviewTMI() {
  var settings = {
    dots: false,
    infinite: true,
    speed: 500,
...
<div>
  <section className="reviewSlider">
    ...
    <h4 className="text-primarycolor text-2xl md:text-3xl font-bold mb-2 md:mb-2 text-center capitalize">Latest attraction reviews on TMI</h4>
...
export default LatestAttrectiveReviewTMI;