...
<div>
  <section className="placetoStay pb-8 md:pb-12">
    ...
    <h4 className="text-primarycolor text-2xl md:text-3xl font-bold mb-2 md:mb-2 text-center">Best Place to stay</h4>
...
export default BestPlaceToStay;