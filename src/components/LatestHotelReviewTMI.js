...
return (
<div>
  <section className="reviewSlider  py-8 md:py-12">
    <div className="container mx-auto px-4">
    <h4 className="text-primarycolor text-2xl md:text-3xl font-bold mb-2 md:mb-2 text-center">Latest hotel reviews on TMI</h4>
...
export default LatestHotelReviewTMI;