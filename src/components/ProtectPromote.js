...
import '../App.css';
import '../App.scss';
function Protectpromote() {
return (
  <section className="py-10 md:py-10 px-4 md:px-16 mx-5 bg-skylight-200 max-w-4xl mx-5 md:mx-auto rounded-2xl mt-5">
    <div className="container mx-auto px-4">
      <div className="flex items-center flex-wrap ">
        <div className="w-full px-2 md:w-1/2">
          <h4 className="text-primarycolor text-2xl md:text-3xl font-bold mb-2 md:mb-2 ">We protect and promote trust</h4>
        ...
        <div className="w-full px-2 md:w-1/2 hidden md:flex items-end justify-end">
          <img src="assets/img/img_protect.svg" alt="img" />
        </div>
      </div>
    </div>
  </section>
