...
return (
<div>
  <section className="placetoStay pb-6 pt-8 md:pt-12 ">
    <div className="container mx-auto px-4">
    <h4 className="text-primarycolor text-2xl md:text-3xl font-bold mb-2 md:mb-2 text-center">Recommended For You</h4>
